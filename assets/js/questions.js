...
const questions = [
    ...
    },
    {
        ...
        answers: [
            { text: "Adele, 25", correct: true },
            { text: "Taylor Swift, 1989", correct: false },
            { text: "Justin Bieber, Purpose", correct: false }
        ]
    },
    {
        question: "Which of the following is an album by punk rock band Anti-Flag?",
        answers: [
            { text: "No Pads, No Helmets...Just Balls", correct: false },
            { text: "For Blood And Empire", correct: true },
            { text: "Infinity On High", correct: false }
        ]
    },
    {
